...
# Fresh install of PyTorch 2.9.1 
...
# Fresh install of Triton 3.5.1
RUN uv pip install --no-cache-dir triton==3.5.1

# Install SageAttention
RUN wget -q -O /tmp/sageattention-2.2.0-cp312-cp312-linux_x86_64.whl \
    "https://github.com/palechinchilla/PrecompiledSageAttentionSM89/raw/refs/heads/main/sageattention-2.2.0-cp312-cp312-linux_x86_64.whl" && \
